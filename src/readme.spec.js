...
describe('readme', () => {
  ...
  describe('buildReadmeContent', () => {
    const context = {
      ...
      projectHomepage:
        'https://github.com/mfomin93/readme-generator#readme',
      projectDemoUrl: 'https://github.com/mfomin93/readme-generator#-demo',
      authorName: 'Mark Fomin',
      authorWebsite: 'https://mfomin93.github.io/portfolio/',
      authorGithubUsername: 'mfomin93',
      authorTwitterUsername: 'vostokrl',
      authorLinkedInUsername: 'mfomin',
      authorPatreonUsername: 'MarkFomin',
